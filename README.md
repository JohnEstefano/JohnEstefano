...
It interacts with both a MySql database and Smartsheet API and has a very specific usecase that takes data from database, modifies it in a very specific way then updates specified Smartsheet sheet. [Smartsheet Project](https://github.com/JohnEstefano/MySQL-Smartsheet-API-Python-Connector)
